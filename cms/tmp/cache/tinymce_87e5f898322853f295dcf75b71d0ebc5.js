...
tinymce.init({
	...
	cmsms_tiny: cmsms_tiny = {
			...
			linker_url : 'http://localhost/cms/admin/moduleinterface.php?mact=TinyMCE,m1_,linker,0&__c=8bee54bcade7634c7dc&showtemplate=false',
			linker_autocomplete_url : 'http://localhost/cms/admin/moduleinterface.php?mact=TinyMCE,m1_,ajax_getpages,0&__c=8bee54bcade7634c7dc&showtemplate=false',
