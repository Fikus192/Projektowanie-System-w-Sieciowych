...
tinymce.init({
    ...
    cmsms_tiny: cmsms_tiny = {
        ...
        filepicker_url: 'http://localhost/cms/admin/moduleinterface.php?mact=FilePicker,m1_,filepicker,0&__c=2db6c611ff053ed7c26&showtemplate=false&field=',
        ...
        linker_url: 'http://localhost/cms/admin/moduleinterface.php?mact=MicroTiny,m1_,linker,0&__c=2db6c611ff053ed7c26&showtemplate=false',
        linker_autocomplete_url: 'http://localhost/cms/admin/moduleinterface.php?mact=MicroTiny,m1_,ajax_getpages,0&__c=2db6c611ff053ed7c26&showtemplate=false',
    ...
    plugins: ['tabfocus hr paste autolink link lists mailto cmsms_linker charmap anchor searchreplace wordcount code fullscreen insertdatetime table media image cmsms_filepicker '],
    // callback functions
